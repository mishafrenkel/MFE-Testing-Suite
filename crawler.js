...
const {encodeHTML, decodeHTML} = require('./utility');
   ...
   return new Promise(async (resolve) => {
      await smta(data, options, (error, list) => {
         for (var url in list) {
            ...
            // let decodedUrl = decodeHTML(list[url].loc);
            console.log('------------------------------------------------------------------ list[url].loc--------->', list[url].loc)
            console.log('------------------------------------------------------------------ type of list[url].loc--------->', typeof list[url].loc)
            console.log('------------------------------------------------------------------ replacing & now--------->', list[url].loc.replace(/&amp;/g, '&'))
            sitemapUrls.push( list[url].loc.replace(/&amp;/g, '&'));
         }
         resolve(sitemapUrls);
      });
   });
