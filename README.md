...
* ```$ git clone https://github.com/mishafrenkel/MFE-Testing-Suite.git or clone using ssh: git clone git@github.com:mishafrenkel/MFE-Testing-Suite.git```
* ```$ npm install```
...
* Use a self made sitemap and Run: `$ node crawler.js -s ./sitemaps/www.example.com.xml --appName random-url
